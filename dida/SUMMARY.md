...
* [安卓应用](android_app/README.md)
   ...
   * [任务列表管理](android_app/list_management.md)
       * [如何建立任务列表?](android_app/1_how_to_create_a_task_list.md)
       * [如何编辑/重命名/删除任务列表?](android_app/2_how_to_editrenamedelete_a_task_list.md)
       * [如何关闭任务列表？](android_app/3_how_to_close_a_task_list.md)
       * [如何分享任务列表?](android_app/4_how_to_share_a_task_list.md)
       * [如何对列表进行排序?](android_app/5_how_to_change_the_order_of_task_lists.md)
       * [如何隐藏一个列表?](android_app/6_how_to_hide_a_task_list_in_all_view.md)
...
* [iOS应用](ios_app/README.md)
   ...
   * [任务列表管理](ios_app/list_management.md)
       * [如何创建任务列表?](ios_app/1_how_to_create_a_task_list.md)
       * [如何编辑/重命名/删除任务列表?](ios_app/2_how_to_editrenamedelete_a_task_list.md)
       * [如何关闭任务列表?](ios_app/3_how_to_close_a_task_list.md)
       * [如何分享任务列表?](ios_app/4_how_to_share_a_task_list.md)
       * [如何对任务列表进行排序?](ios_app/5_how_to_change_the_order_of_task_lists.md)
       * [如何使一个列表中的任务不在‘所有’中显示?](ios_app/6_how_to_hide_a_task_list_from_all_view.md)
...
* [谷歌浏览器插件](chrome_extension_app/README.md)
   ...
   * [任务列表管理](translation/README.md)
       * [如何创建一个任务列表?](translation/1.md)
       * [如何重命名一个列表？](translation/2.md)
       * [如何删除一个列表?](translation/3.md)
       * [如何分享一个列表?](translation/4.md)
       * [如何关闭一个列表?](translation/5.md)
