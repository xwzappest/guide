...
* [TickTick web app](ticktick_web_app/README.md)
   * [Preference Settings](ticktick_web_app/preference_settings.md)
       ...
       * [How to change "Start Day of Week" in TickTick's Calendar?](ticktick_web_app/how_to_set_the_start_of_week.md)
   ...
   * [Task management](ticktick_web_app/task_management.md)
       ...
       * [What shortcuts can I use in TickTick ?](ticktick_web_app/what_shortcuts_can_i_use_in_ticktick.md)
...
* [Android App](android_app/README.md)
   * [Installation & Account](android_app/installation_&_account.md)
       ...
       * [How should I do if I still can't use premium features after I purchase TickTick?](android_app/how_should_i_do_if_i_still_cant_use_premium_features_after_i_purchase_ticktick.md)
   ...
   * [Task Management](android_app/task_management.md)
       ...
       * [How to delete completed tasks in each task list?](android_app/4_how_to_archive_tasks.md)
       ...
       * [How to set default characteristics of a new task ?](android_app/7_how_to_set_default_due_date_for_new_task.md)
       ...
       * [How to make a phone call directly through a task?](android_app/can_i_make_a_phone_call_directly_through_a_task.md)
       * [How to search a task?](android_app/how_to_search_a_task.md)
   * [List Management](android_app/list_management.md)
       * [How many default lists are there in TickTick?](android_app/how_many_default_lists_are_there_in_ticktick.md)
       * [ How to create a task list?](android_app/1_how_to_create_a_task_list.md)
       * [How to rename/delete/hide a task list?](android_app/2_how_to_editrenamedelete_a_task_list.md)
       ...
       * [How to assign a task list to someone?](android_app/how_to_assign_a_task_list.md)
   ...
   * [Reminder](android_app/reminder.md)
       * [How to set due date & reminder of a task?](android_app/1_how_to_set_due_date_&_reminder_for_a_task.md)
       * [How to set a default reminder time before the exact reminder? ](android_app/can_i_set_a_default_reminder_some_time_before_the_exact_reminder.md)
       ...
       * [How to undo edit in due date and reminder?](android_app/how_to_discard_changes_of_due_date_and_reminder.md)
       ...
       * [How to add a permenant notification bar with Today's tasks to your phone's pull-down screen?](android_app/8_how_to_enable_reminder_in_status_bar.md)
